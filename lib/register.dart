                      ...
                      children: <Widget>[
                        new Container(
                          ...
                          child: new DecoratedBox(
                              decoration: BoxDecoration(
                                border: new Border.all(color: const Color(0xFF006633),width: 2.0),
                                image: new DecorationImage(
                                    image: new AssetImage("images/addpic.png",),
                                ),
                        ...
                        new Opacity(
                          ...
                          child: new Container(
                            ...
                            child: new RaisedButton(
                              ...
                              child: new Text("Add Image",style: new TextStyle(color: Colors.white,fontSize: 15.0)),
                        ...
                        new Opacity(
                          ...
                          child: new Container(
                            ...
                            child: new RaisedButton(
                              onPressed: _alertDialog,
                              child: new Text("CREATE ACCOUNT",style: new TextStyle(color: Colors.white,fontSize: 20.0)),
                              color: const Color(0xFF006633),
                              shape: new RoundedRectangleBorder(
                                  borderRadius: new BorderRadius.circular(30.0)
                              ),
